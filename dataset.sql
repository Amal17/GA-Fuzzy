...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 03, 2019 at 08:04 AM
...
--
-- Table structure for table `breastcancerwisconsin`
--

CREATE TABLE `breastcancerwisconsin` (
  `ID` varchar(8) NOT NULL,
  `Ketebalan_Rumpun` varchar(2) NOT NULL,
  `Keseragaman_Ukuran_Sel` varchar(2) NOT NULL,
  `Keseragaman_Bentuk_Sel` varchar(2) NOT NULL,
  `Adhesi_Marjinal` varchar(2) NOT NULL,
  `Sel_Epitel_Tunggal_Ukuran` varchar(2) NOT NULL,
  `Bare_Nuclei` varchar(2) NOT NULL,
  `Bland_Chromatin` varchar(2) NOT NULL,
  `Nukleoli_Normal` varchar(2) NOT NULL,
  `Mitosis` varchar(2) NOT NULL,
  `Kategori` varchar(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `breastcancerwisconsin`
--

INSERT INTO `breastcancerwisconsin` (`ID`, `Ketebalan_Rumpun`, `Keseragaman_Ukuran_Sel`, `Keseragaman_Bentuk_Sel`, `Adhesi_Marjinal`, `Sel_Epitel_Tunggal_Ukuran`, `Bare_Nuclei`, `Bland_Chromatin`, `Nukleoli_Normal`, `Mitosis`, `Kategori`) VALUES
...
--
-- Indexes for table `breastcancerwisconsin`
--
ALTER TABLE `breastcancerwisconsin`
  ADD PRIMARY KEY (`ID`);
COMMIT;
